                ...
                <v-list-item>
                  <v-list-item-content>
                    <v-list-item-title class="text-caption grey--text text--darken-1">
                      لطفاً روش تامین را انتخاب کنید
                    </v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <v-divider></v-divider>
  ...
  export default {
    ...
    data() {
      return {
        selectedMean: null,
        means: [
          { value: "unknown_vending", name: "نامشخص" },
          { value: "burux_vending", name: "تامین بروکس" },
          { value: "360_vending", name: "تامین 360" },
          { value: "sure_vendor_vending", name: "تامین کننده خارجی مطمئن" },
          { value: "risky_vendor_vendong", name:"تامین کننده خارجی ریسکی" },
          { value: "negotiable_vendor_vending", name: "تامین کننده خارجی نیاز به مذاکره" },
        ],
      };
    },
    methods: {
      ...
      confirmAssign() {
        const data = {
          ...
          vending_type: this.selectedMean,
        };
